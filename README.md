...
As for my views on using AI, I don't mind the use of AI, it's inevitable. But just like people were against/skeptical of the internet when it became mainstream, it is not a replacement for the human aspect of communication, rather a cheap immitation. Talking to someone in person is a lot better than over Discord or Skype etc. But when you can't talk to someone it is convenient to use the internet even though it's not nearly the same connection, being seperated rather than physically present. The argument can be made that you can put in the effort to travel to that person to talk to them, but that is time and effort, usually time someone doesnt have. The same goes for the use of AI, I can definitely learn Java to make the mod but its a lot of effort and time, time that I dont have. Where I find AI unacceptable is where the human element is most prevelant, like art and literature, you take the the soul out of those works by using AI. On the otherhand, to use AI for programming is a bit better, as the main element isnt the human one, it's the functionality of the code. Yes it can result in vulnerabilities if used irrisponsibly, that is why it should not be used for major infrastructure or in critical sectors. If the fact that I used AI changes your opinion on the mod or myself, I do apologise. This is only a tool for making and sharing scripts in the end. 
